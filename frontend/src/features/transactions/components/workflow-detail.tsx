    ...
    <div className="rounded-lg border bg-card p-4 shadow-sm">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Button variant="outline" size="sm" className="h-7 text-xs" asChild>
            <a href={`/debugger?updateId=${tx.updateId}`}>
      ...
      <div className="grid grid-cols-2 gap-x-8 gap-y-3 overflow-hidden lg:grid-cols-4">
        ...
        <div>
          ...
          <div className="mt-0.5">
            <IdBadge id={tx.offset} monospace />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-0.5">
            {tx.traceContext?.traceParent ? (
              <IdBadge id={tx.traceContext.traceParent} truncateLen={12} />
            ) : (
              <span className="text-xs text-muted-foreground">--</span>
            )}
          </div>
